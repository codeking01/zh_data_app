...
class Ui_zh_data_app(object):
    def setupUi(self, zh_data_app):
        ...
        self.groupBox_2 = QGroupBox(zh_data_app)
        self.groupBox_2.setObjectName(u"groupBox_2")
        self.groupBox_2.setGeometry(QRect(290, 10, 611, 451))
...
"}")
        ...
        self.predict_progressBar.setCursor(QCursor(Qt.ArrowCursor))
        self.predict_progressBar.setStyleSheet(u"")
        self.predict_progressBar.setValue(0)

        self.gridLayout_6.addWidget(self.predict_progressBar, 1, 3, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.train_progressBar, 0, 3, 1, 1)
        ...
        self.train_stop_button.setFont(font2)
        ...
        self.predict_stop_button_2 = QPushButton(self.groupBox)
        self.predict_stop_button_2.setObjectName(u"predict_stop_button_2")
        self.predict_stop_button_2.setFont(font2)
        self.predict_stop_button_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.predict_stop_button_2.setStyleSheet(u"")

        self.gridLayout_5.addWidget(self.predict_stop_button_2, 5, 2, 1, 1, Qt.AlignHCenter)
        ...
        self.modeling_file_path.setFont(font2)
        ...
        self.horizontalSpacer_14 = QSpacerItem(76, 40, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.gridLayout_2.addItem(self.horizontalSpacer_14, 0, 3, 1, 1)

        self.horizontalSpacer_11 = QSpacerItem(55, 40, QSizePolicy.Fixed, QSizePolicy.Minimum)
        ...
        self.horizontalSpacer_12 = QSpacerItem(60, 40, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.gridLayout.addItem(self.horizontalSpacer_12, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.predict_file_path, 2, 2, 1, 2)
        ...
        self.horizontalSpacer_9 = QSpacerItem(60, 40, QSizePolicy.Fixed, QSizePolicy.Minimum)
        ...
        self.gridLayout.addWidget(self.modeling_exist_file_path, 0, 2, 1, 2)

        self.horizontalSpacer_13 = QSpacerItem(60, 40, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.gridLayout.addItem(self.horizontalSpacer_13, 2, 4, 1, 1)

        self.horizontalSpacer_15 = QSpacerItem(71, 40, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.gridLayout.addItem(self.horizontalSpacer_15, 0, 4, 1, 1)
        ...
        self.groupBox_3 = QGroupBox(zh_data_app)
        self.groupBox_3.setObjectName(u"groupBox_3")
        self.groupBox_3.setGeometry(QRect(10, 10, 281, 451))
        self.groupBox_3.setStyleSheet(u"QGroupBox{\n"
"	background-color: rgb(255, 255, 255);\n"
"}")
        self.line = QFrame(self.groupBox_3)
        self.line.setObjectName(u"line")
        self.line.setGeometry(QRect(50, 90, 171, 21))
        self.line.setFrameShape(QFrame.HLine)
        self.line.setFrameShadow(QFrame.Sunken)
        self.label = QLabel(self.groupBox_3)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(80, 60, 111, 27))
        font3 = QFont()
        ...
        self.label_4.setGeometry(QRect(30, 140, 201, 191))
    ...
    def retranslateUi(self, zh_data_app):
        ...
        self.predict_stop_button_2.setText(QCoreApplication.translate("zh_data_app", u"\u7ec8\u6b62", None))
